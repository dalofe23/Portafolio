const translations = {
	es: {
		...
		'stat-label1': 'Tecnologías Dominadas',
		'stat-label2': '% Satisfacción Cliente',
		'languages-title': 'Idiomas',
		'lang-spanish': 'Español',
		'lang-spanish-level': 'Nativo',
		'lang-english': 'Inglés',
		'lang-english-level': 'Intermedio',
		...
		'skills-tools-title': 'Tools & IDEs',
		'skills-databases-title': 'Databases',
		'skills-devops-title': 'DevOps',
		'skills-soft-title': 'Soft Skills',
		'skills-soft-item1': 'Trabajo en Equipo',
		'skills-soft-item2': 'Resolución de Problemas',
		'skills-soft-item3': 'Adaptabilidad',
		'skills-soft-item4': 'Comunicación Efectiva',
		...
		'cv-subtitle': 'Descarga mi CV en tu idioma preferido',
	...
	en: {
		...
		'stat-label1': 'Technologies Mastered',
		'stat-label2': '% Client Satisfaction',
		...
		'skills-devops-title': 'DevOps',
		'skills-soft-title': 'Soft Skills',
		'skills-soft-item1': 'Teamwork',
		'skills-soft-item2': 'Problem Solving',
		'skills-soft-item3': 'Adaptability',
		'skills-soft-item4': 'Effective Communication',
		...
		'cv-subtitle': 'Download my CV in your preferred language',
